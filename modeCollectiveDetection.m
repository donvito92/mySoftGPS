function [collectiveCorrelogram count] = modeCollectiveDetection(roughEstimate, satPositions, satClkCorr, results, eph, settings, acqResults)

% This function is a faster version of collective detection, even faster than the myCollectiveDetection. 
% It finds out the mode clock-bias for all satellite and uses this candidate for
